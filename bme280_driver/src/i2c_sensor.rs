use crate::error::{Error, I2cError, Result};
use crate::fmt::*;
use crate::regs::*;
use crate::states::*;
...
impl<I2C> Bme280I2C<I2C, Sleep>
where
    I2C: I2cTrait,
{
    pub fn new(i2c: I2C, addr: u8) -> Self {
        Self::new_with_config(i2c, addr, Config::default())
    }

    pub(crate) fn new_with_config(i2c: I2C, addr: u8, config: Config) -> Self {
        Self {
            i2c,
            addr,
            config,
    ...
    pub async fn into_normal_mode(mut self) -> Result<Bme280I2C<I2C, Normal>> {
    ...
    pub async fn into_forced_mode(mut self) -> Result<Bme280I2C<I2C, Forced>> {
    ...
    I2C: I2cTrait,
{
    ...
    pub async fn stop(mut self) -> Result<Bme280I2C<I2C, Sleep>> {
        self.config.mode = Mode::Sleep;
        self.apply_config().await?;
        Ok(Bme280I2C {
            i2c: self.i2c,
